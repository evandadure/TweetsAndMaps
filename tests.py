...
geolocator = Nominatim(user_agent="monAppTwitter")
location = geolocator.geocode("Saint-Ours, France")

print((location.latitude, location.longitude))



#il faut un point de l'arête sous la droite et un "au dessus ou exactement sur" la droite
